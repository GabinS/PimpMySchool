...
public class VideoProjecteur extends RessourceMaterielle {
	...
	/**
	 * Récupère le nom du Vidéoprojecteur
	 * @return Le nom du Vidéoprojecteur
	 */
	...
	/**
	 * Défini le nom du Vidéoprojecteur
	 * @param nom Le nouveau nom du Vidéoprojecteur
	 */
	...
	public VideoProjecteur(String nom, int resolution, int dureeVieLampe, String typeLampe, Date dateAchat) {
