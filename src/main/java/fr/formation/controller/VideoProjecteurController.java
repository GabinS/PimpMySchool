...
public class VideoProjecteurController {
	...
	//TODO: Créer une action permettant de définir l'utilisation 
	// du matériel directement dans la liste. La date de début correspondrait
	// au moment où l'utilisateur appuie sur le bouton "Utiliser le matériel" et la date de fin
	// "Ne plus utiliser le matériel".
